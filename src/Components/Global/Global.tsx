	...
	return (
		<div className='flex justify-between px-4 py-2 mx-auto mb-6 text-xs rounded-b-lg md:w-1/2 dark:bg-black dark:text-gray-50'>
			<div className='flex flex-col'>
				<p className='font-light text-gray-500'>Coins:</p>
				<span className='font-light text-blue-400'>{active_cryptocurrencies}</span>
			</div>
			<div>
				<p className='font-light text-gray-500'>Exchange:</p>
				<span className='font-light text-blue-400'>{markets}</span>
			</div>
			<div>
				<p className='font-light text-gray-500'>Market Cap:</p>
				<span className='font-light text-blue-400'>
					${millify(total_market_cap[currency] ? total_market_cap[currency] : 0)}
				</span>
			</div>
			<div>
				<p className='font-light text-gray-500'>24h Vol:</p>
				<span className='font-light text-blue-400'>
					${millify(total_volume[currency] ? total_volume[currency] : 0)}
				</span>
			</div>
			<div>
				<p className='font-light text-gray-500'>Dominance:</p>
				<span className='font-light text-blue-400'>
